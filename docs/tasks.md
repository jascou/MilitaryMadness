...
84. [ ] Ensure action execution sequencing renders between actions and respects turn rules; add zero-delay option for tests. (phase 3/4)
85. [ ] UX polish: show non-modal "AI thinking…" indicator and disable human input during AI turn; make delay configurable. (phase 4)
